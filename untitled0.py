...
data_R_books = change_pictures_names.resize(os.listdir(os.path.join(path, r'sorted\recycle\books')), os.path.join(path, r'sorted\recycle\books'))
data_R_cardboard = change_pictures_names.resize(os.listdir(os.path.join(path, r'sorted\recycle\cardboard')), os.path.join(path, r'sorted\recycle\cardboard'))
data_R_glass_bottles = change_pictures_names.resize(os.listdir(os.path.join(path, r'sorted\recycle\glass bottles')), os.path.join(path, r'sorted\recycle\glass bottles'))
data_R_newspapers = change_pictures_names.resize(os.listdir(os.path.join(path, r'sorted\recycle\newspapers')), os.path.join(path, r'sorted\recycle\newspapers'))
data_O_fruits = change_pictures_names.resize(os.listdir(os.path.join(path, r'sorted\not-recycle\fruits')), os.path.join(path, r'sorted\not-recycle\fruits'))
data_O_meat = change_pictures_names.resize(os.listdir(os.path.join(path, r'sorted\not-recycle\meat')), os.path.join(path, r'sorted\not-recycle\meat'))
data_O_nature = change_pictures_names.resize(os.listdir(os.path.join(path, r'sorted\not-recycle\nature')), os.path.join(path, r'sorted\not-recycle\nature'))
data_O_vegtables = change_pictures_names.resize(os.listdir(os.path.join(path, r'sorted\not-recycle\vegtables')), os.path.join(path, r'sorted\not-recycle\vegtables'))

"""
l_book=os.listdir(os.path.join(path, r'sorted\recycle\books'))
change_pictures_names.brighting_image(l_book, os.path.join(path, r'sorted\recycle\books'),'\\recycle\\books', int(6000/len(l_book)), "book")

l_cardboard=os.listdir(os.path.join(path, r'sorted\recycle\cardboard'))
change_pictures_names.brighting_image(l_cardboard, os.path.join(path, r'sorted\recycle\cardboard'),'\\recycle\\cardboard', int(6000/len(l_cardboard)), "cardboard")

l_glass_bottles=os.listdir(os.path.join(path, r'sorted\recycle\glass bottles'))
change_pictures_names.brighting_image(l_glass_bottles, os.path.join(path, r'sorted\recycle\glass bottles'),'\\recycle\\glass bottles', int(6000/len(l_glass_bottles)), "glass_bottle")

l_newspapers=os.listdir(os.path.join(path, r'sorted\recycle\newspapers'))
change_pictures_names.brighting_image(l_newspapers, os.path.join(path, r'sorted\recycle\newspapers'),'\\recycle\\newspapers', int(6000/len(l_newspapers)), "newspaper")

l_fruits=os.listdir(os.path.join(path, r'sorted\not-recycle\fruits'))
change_pictures_names.brighting_image(l_fruits, os.path.join(path, r'sorted\not-recycle\fruits'),'\\not-recycle\\fruits', int(6000/len(l_fruits)), "fruit")

l_meat=os.listdir(os.path.join(path, r'sorted\not-recycle\meat'))
change_pictures_names.brighting_image(l_meat, os.path.join(path, r'sorted\not-recycle\meat'),'\\not-recycle\\meat', int(6000/len(l_meat)), "meat")

l_nature=os.listdir(os.path.join(path, r'sorted\not-recycle\nature'))
change_pictures_names.brighting_image(l_nature, os.path.join(path, r'sorted\not-recycle\nature'),'\\not-recycle\\nature', int(6000/len(l_nature)), "nature")

l_vegtables=os.listdir(os.path.join(path, r'sorted\not-recycle\vegtables'))
change_pictures_names.brighting_image(l_vegtables, os.path.join(path, r'sorted\not-recycle\vegtables'),'\\not-recycle\\vegtables', int(6000/len(l_vegtables)), "vegtable")
"""

train_books, test_books, validation_books = split_train_test_validation.split_train_test_val(os.listdir(os.path.join(path, r'augmented\recycle\books')))
train_cardboard, test_cardboard, validation_cardboard =  split_train_test_validation.split_train_test_val(os.listdir(os.path.join(path, r'augmented\recycle\cardboard')))
train_glass_bottles, test_glass_bottles, validation_glass_bottles = split_train_test_validation.split_train_test_val(os.listdir(os.path.join(path, r'augmented\recycle\glass bottles')))
train_newspapers, test_newspapers, validation_newspapers = split_train_test_validation.split_train_test_val(os.listdir(os.path.join(path, r'augmented\recycle\newspapers')))

train_fruits, test_fruits, validation_fruits = split_train_test_validation.split_train_test_val(os.listdir(os.path.join(path, r'augmented\not-recycle\fruits')))
train_meat, test_meat, validation_meat = split_train_test_validation.split_train_test_val(os.listdir(os.path.join(path, r'augmented\not-recycle\meat')))
train_nature, test_nature, validation_nature = split_train_test_validation.split_train_test_val(os.listdir(os.path.join(path, r'augmented\not-recycle\nature')))
train_vegtables, test_vegtables, validation_vegtables = split_train_test_validation.split_train_test_val(os.listdir(os.path.join(path, r'augmented\not-recycle\vegtables')))
